class Plot < ActiveRecord::Base
  @@nouns = ["A man", "A woman", "A whale", "A ghost", "A cat", "An assassin", "A thief", "An alien", "A baby", "A European tourist", "An Olympic athlete", "A wizard", "The villian", "A penguin", "A sentient robot", "A sorceress"]
